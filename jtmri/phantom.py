...
# Retrieved from http://code.google.com/p/cat-py/source/browse/trunk/phantom.py
# on 2012-11-20
##
# 2015-04-23: Modified to return masks for each ellipse


import numpy as np

def phantom(n=256, p_type='Modified Shepp-Logan', ellipses=None, ret_masks=False):
    """
    ...
    ret_masks : Return a list of masks representing each ellipse drawn
